...
S=${DMESH_SCRIPT_DIR:-/tmp/dmesh-scratch}; HOST=192.168.100.1
...
for MODE in off on; do
  ...
  ssh -o BatchMode=yes $HOST "for i in 1 2; do ~/dpumesh/DeathStarBench/wrk2/wrk -D exp -t 8 -c 128 -d20s -L -s $LUA http://127.0.0.1:5000 -R 3000 >/dev/null 2>&1; done" </dev/null; echo "  warmup done"
