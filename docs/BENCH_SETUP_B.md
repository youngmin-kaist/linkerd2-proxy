...
### 노드 간 1코어 비교: rapids4 vs jet1 (2026-09-03, jet-bf-dmesh 세션과 교차 측정)

jet의 "15k"는 M=1·`-m100`·DPA ingress·비샤딩 하네스였고, **같은 하네스(sb-l7.sh, sharded, -c1 -m300)면
jet가 더 빠름**. 응답 크기를 맞추자(`H2PATH=/ok`, 3B) 격차가 4k→~1.7k(8%)로 줄었다.

| 1코어, sharded W=1, -c1 -m300 ×M | rapids4 (DOCA 3.1, Xeon 6554S) | jet1 (DOCA 3.5, Xeon 6515P) |
|---|---|---|
| M=1 | 15,595 (896B) | 20,761 (3B) |
| M=2 | 16,023 (896B) / **18,797 (3B)** | 21,893 (3B) |
| M=4 | 17,155·16,835 (896B) / 18,500·18,151 (153B 404) / **19,545·19,217 (3B)** | 21,064·21,055 (3B) |
| DPU busy | ~1.3–1.4 | ~1.2–1.3 |

- 응답 크기 민감도(rapids4): 896B→153B +7.5%, →3B +13% (push 바이트·h2 프레이밍).
